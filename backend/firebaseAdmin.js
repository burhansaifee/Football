...
try {
    ...
    if (serviceAccountJsonStr) {
        ...
        console.warn("FIREBASE_SERVICE_ACCOUNT_JSON or FIREBASE_SERVICE_ACCOUNT_PATH is not defined in .env! Make sure to fully restart your backend server so it can read the new .env file.");
